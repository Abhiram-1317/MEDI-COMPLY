...
CONDITION_TO_ICD10_MAP: dict[str, list[tuple[str, float]]] = {
    ...
    # Pulmonary
    "copd": [("J44.1", 0.80)],
    "copd acute exacerbation": [("J44.1", 0.90)],
    "copd with acute exacerbation": [("J44.1", 0.90)],
    "copd with acute lower respiratory infection": [("J44.0", 0.90)],
    ...
    "sepsis": [("A41.9", 0.75)],
    "tobacco use": [("F17.210", 0.85)],
    "former tobacco use": [("Z87.891", 0.90)],
    "obesity": [("E66.01", 0.80)],
